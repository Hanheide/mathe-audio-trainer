...
<body>
  <main class="card">
    ...
    <section class="stats">
      ...
      <div>Falsch: <span id="wrong">0</span></div>
      <div>Streak: <span id="streak">0</span></div>
    </section>

    <div class="time-box">
      <span id="time">Zeit: 0.00 s</span> |
      <span id="avg">Ø: 0.00 s</span>
    </div>

    <!-- ✅ NUR HINZU: Bestenliste -->
    <section class="leaderboard">
      ...
      <div class="lb-head">
        <span id="lb-mode">Modus: -</span>
        <span class="lb-note">Speichert nach 10 richtigen Aufgaben</span>
      </div>
      <ol id="leaderboard-list">
        <li>Noch keine Einträge</li>
      </ol>
      <div id="lb-error" class="lb-error"></div>
    </section>

    <p class="hint">Enter = prüfen · Space = wiederholen</p>
  </main>
  ...
  <script type="module">
    ...
    window.db = db;
    window.fs = { collection, addDoc, getDocs, query, orderBy, limit, serverTimestamp };
